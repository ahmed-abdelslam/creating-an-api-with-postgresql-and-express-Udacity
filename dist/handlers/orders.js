...
var update = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var order, updatedOrder, error_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                ...
                return [4 /*yield*/, store.update(order, req.params.id)];
            case 1:
...
var addProduct = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var orderId, productId, quantity, addedProduct, error_3;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
...
var getCurrentOrdersByUserId = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, store.getCurrentOrdersByUserId(userId)];
            case 2:
                orders = _a.sent();
                res.json(orders);
                return [3 /*break*/, 4];
...
var orderRoutes = function (app) {
    ...
    app.get('/orders/user/:user_id', verifyAuthToken_1.verifyAuthToken, getCurrentOrdersByUserId);
    app.post('/order/:id/products', verifyAuthToken_1.verifyAuthToken, addProduct);
};
