...
var UserStore = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_2 = _a.sent();
                        throw new Error("Error occured while fetching user ".concat(id, ". Error: ").concat(error_2));
                    case 4: return [2 /*return*/];
                }
            });
        });
    ...
    UserStore.prototype.create = function (u) {
        return __awaiter(this, void 0, void 0, function () {
            var conn, sql, hashPassword, result, error_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                    ...
                    case 1:
                        ...
                        hashPassword = bcrypt_1["default"].hashSync(u.password + pepper, parseInt(saltRounds));
                        return [4 /*yield*/, conn.query(sql, [u.username, u.firstname, u.lastname, hashPassword])];
                    case 2:
                        result = _a.sent();
                        conn.release();
                        return [2 /*return*/, result.rows[0]];
                    case 3:
                        error_3 = _a.sent();
                        throw new Error("Could not add new user ".concat(u.firstname, ". Error: ").concat(error_3));
                    case 4: return [2 /*return*/];
                }
            });
        });
    ...
    UserStore.prototype.update = function (u, id) {
        return __awaiter(this, void 0, void 0, function () {
            var conn, sql, hashPassword, result, error_4;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                    ...
                    case 1:
                        conn = _a.sent();
                        sql = 'UPDATE users SET username=($1), firstname=($2), lastname=($3), password=($4) WHERE id=($5) RETURNING *';
                        hashPassword = bcrypt_1["default"].hashSync(u.password + pepper, parseInt(saltRounds));
                        return [4 /*yield*/, conn.query(sql, [u.username, u.firstname, u.lastname, hashPassword, id])];
                    case 2:
                        result = _a.sent();
                        conn.release();
                        return [2 /*return*/, result.rows[0]];
