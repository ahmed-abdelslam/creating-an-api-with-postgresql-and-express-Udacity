...
var OrderStore = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_2 = _a.sent();
                        throw new Error("Could not find order {$id}. Error: ".concat(error_2));
                    case 4: return [2 /*return*/];
                }
            });
        });
    ...
    OrderStore.prototype.update = function (o, id) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_5 = _a.sent();
                        throw new Error("Could not update order ".concat(o.id, ". Error: ").concat(error_5));
                    case 4: return [2 /*return*/];
                }
            });
        });
    };
    OrderStore.prototype.getCurrentOrdersByUserId = function (userId) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_6 = _a.sent();
                        throw new Error("Could not get orders of user ".concat(userId, "}. Error: ").concat(error_6));
                    case 4: return [2 /*return*/];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_7 = _a.sent();
                        throw new Error("Could not delete order ".concat(id, ". Error: ").concat(error_7));
                    case 4: return [2 /*return*/];
                }
            });
        });
